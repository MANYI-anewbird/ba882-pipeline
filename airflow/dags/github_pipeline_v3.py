...
FUNCTIONS = {
    ...
    # --- Final ML aggregation ---
    "transform_repo_ml": "https://us-central1-ba-882-fall25-team8.cloudfunctions.net/transform-repo-ml",
}
...
with DAG(
    ...
    transform_repo_ml = BashOperator(
        task_id="transform_repo_ml_dataset",
        bash_command=f'curl -X POST "{FUNCTIONS["transform_repo_ml"]}" '
                     '-H "Content-Type: application/json" -d \'{{}}\''
    )
    ...
    [transform_repos, transform_contributors, transform_commits, transform_languages] >> transform_repo_ml
